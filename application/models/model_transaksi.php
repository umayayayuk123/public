...
class model_transaksi extends ci_model
{
    ...
    function detail_transaksi_by_id($id)
    {
        return $this->db->query("
                                SELECT * from transaksi,transaksi_detail
                                where 
                                transaksi.transaksi_id = transaksi_detail.transaksi_id
                                and transaksi.transaksi_id = $id
        ");
    }
    function tampilkan_detail_transaksi($status)
    {
        $query  ="SELECT td.t_detail_id,td.qty,td.harga,b.nama_barang
                ...
                WHERE b.barang_id=td.barang_id and td.status='$status'";
    ...
    {
        return $this->db->query("
                                select sum(transaksi_detail.harga*transaksi_detail.qty) as total
