...
<body>
  <table border="0"  cellpadding="10" cellspacing="0" width="89%" align="center">
    <tr style="border: 5px ">
      ...
      <td>
        <p style="color: white;font-size: 14pt;font-family:astanafont;margin-right: -40px;margin-top: 10px"><b><script>document.write(thisDay + ', ' + day + ' ' + months[month] + ' ' + year);</script></b></p>
      </td>
    </tr>
    <tr>
      <td colspan="4">
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="Jumbotron" width="100%">
              <center><h2><b>EASY PRINTING (DIGITAL PRINTING OUTDOR  <br>INDOR & OFFSET PRINTING)<br>
              <br><center><p align="j">EASY PRINTING, berdiri sebagai sebuah perusahan dengan fokus di bidang Produk Percetakan, Penjualan Barang & Jasa. Perusahaan kami menawarkan kerja sama dengan berbagai Perusahaan Swasta maupun Dinas/Instansi Pemerintah pada berbagai bentuk perkerjaan sesuai bidang keahlian perusahaan kami.<br>
              </p></center>
              <br>
              <center><small><b>*) Untuk Mendapatkan Informasi Update Terbaru Silahkan Daftar</b></small></center><br>
              <center>
                <a href="#" class="hvr-bounce-to-right btn btn-default"> Daftar</a>
                <a href="#" class="hvr-bounce-to-right btn btn-default"> Login Aadministrasi</a>
                <a href="#" class="hvr-bounce-to-right btn btn-default"> Lihat Pesanan Saya</a>
              </center>
            </div>
          </div>
          <div class="col-md-4">
    ...
    <tr>
      <td colspan="4">
        <label for="" style="position: absolute;margin-left: 70px;margin-top: 10px;font-family: arial;color: white"></label>
