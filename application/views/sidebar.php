        ...
        <ul class="nav" id="main-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li  class="list-sidebar">
                    <a href="<?php echo base_url().'transaksi_aruskas/list_transaksi'?>"><i class="glyphicon glyphicon-book"></i> Laporan Arus Kas </a></li>
                </ul>
                </li>
                ...
                <li>
                    <a href="javascript:void(0)"><i class="fa fa-print"></i>Transaksi Pesanan<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
