...
INSERT INTO `arus_kas` (`id_kas`, `tanggal`, `penjualan`, `foto_copy`, `cetakan`, `banner_sticker`, `laser_A3`, `Sobirin`, `Sri`, `Dian`, `Hariyanto`, `Mila`, `Zaenal`, `pendapatan`, `pengeluaran`, `keterangan`) VALUES
	(1, '2018-07-03', 100000, 40000, 50000, 100000, 60000, 670000, 6000, 2000, 1000, 67000, 6578, 10000, 67888, 'laminasi'),
	(2, '2018-07-04', 100000, 7000, 5000, 70000, 10000, 900000, 560000, 50000, 40000, 27000, 3000, 80000, 77777, 'Kertas F4 2 Box'),
	(3, '2018-07-05', 100000, 7000, 100000, 70000, 2000, 900000, 560000, 50000, 40000, 70999, 5000, 80000, 77777, 'laminasi'),
	(4, '2018-07-06', 50000, 77800, 12000, 50000, 67000, 870000, 23000, 65000, 12000, 34555, 45777, 90999, 34000, 'Laminasi '),
	(5, '2018-07-07', 2000, 70000, 7000, 800, 8700, 98000, 89000, 87600, 8776, 89000, 8999, 78000, 70, 'Kertas A4'),
	(6, '2018-07-08', 500, 7000, 300000, 70000, 10000, 900000, 560000, 50000, 40000, 28000, 3000, 80000, 77777, 'Kertas F4 2 Box'),
	(7, '2018-07-08', 1000, 8000, 10000, 10000, 10000, 5000, 70000, 9000, 6000, 9000, 8000, 6000, 4000, 'Cetak AP'),
	(8, '2018-07-09', 100000, 8000, 5000, 70000, 20000, 900000, 560000, 50000, 40000, 13000, 5000, 80000, 77777, 'Kertas F4 2 Box'),
	(9, '2018-07-09', 1000, 8000, 5000, 70000, 10000, 900000, 560000, 50000, 40000, 20000, 18000, 80000, 77777, 'Kertas F4 2 Box'),
	(10, '2018-07-09', 100000, 7000, 5000, 70000, 10000, 900000, 560000, 50000, 40000, 70000, 500000, 80000, 77777, 'Kertas F4 2 Box');
...
CREATE TABLE IF NOT EXISTS `databon` (
  ...
  PRIMARY KEY (`no_nota`)
) ENGINE=InnoDB AUTO_INCREMENT=98988008 DEFAULT CHARSET=latin1;
...
INSERT INTO `databon` (`tanggal`, `no_nota`, `item_barang`, `QTY`, `harga`, `jumlah`, `sisa`, `bayar`, `status`) VALUES
	...
	('2020-02-11', 98988007, '326', 500, 1200, 600000, 0, 100000, '');
...
-- Membuang data untuk tabel e_pos.data_kategori_job: ~5 rows (lebih kurang)
...
-- Membuang data untuk tabel e_pos.detail_arus_kas: ~3 rows (lebih kurang)
/*!40000 ALTER TABLE `detail_arus_kas` DISABLE KEYS */;
INSERT INTO `detail_arus_kas` (`t_aruskas_id`, `job_karyawan_id`, `qty`, `aruskas_id`, `harga`, `status`) VALUES
	(7, 14, 400, 1, 50000, '1'),
	(8, 14, 10, 1, 50000, '1'),
	(9, 14, 66, 1, 50000, '1'),
	(10, 14, 100, 1, 50000, '1'),
...
-- Membuang data untuk tabel e_pos.detail_order: ~11 rows (lebih kurang)
...
INSERT INTO `detail_order` (`t_detail_order_id`, `barang_pesanan_id`, `qty`, `no_nota`, `harga`, `status`) VALUES
	...
	(20, 11, 3, 17, 10000, '1'),
	(21, 9, 100, 17, 50000, '1'),
	(22, 12, 100, 17, 50000, '1'),
	(23, 12, 100, 18, 50000, '1'),
	(24, 11, 400, 18, 10000, '1'),
	(25, 10, 100, 18, 100000, '1');
...
INSERT INTO `operator` (`operator_id`, `id_hak_akses`, `nama_lengkap`, `username`, `password`, `last_login`) VALUES
	('OP003', 'HA02', 'Asma Binnuril Qolbi', 'Asma', 'ecd60eb22cf6c82b8c296694fe46a413', '2020-02-10'),
	('OP004', 'HA01', 'Yayuk Umaya', 'Maya', 'ecd60eb22cf6c82b8c296694fe46a413', '2020-02-10'),
	('OP001', 'HA01', 'MasyaaAllah', 'Shasa', '78b318cfbc9c02945a5f7a39af4e72d7', '2020-02-10'),
	('OP002', 'HA01', 'Faiz Alka', 'Faiz', '78b318cfbc9c02945a5f7a39af4e72d7', '2020-02-10');
...
-- Membuang data untuk tabel e_pos.tb_order: ~4 rows (lebih kurang)
...
INSERT INTO `tb_order` (`no_nota`, `is_selesai`, `tanggal_order`, `operator_id`, `nama_customer`) VALUES
	...
	(16, '1', '2020-02-02', 'OP002', 'Indah'),
	(17, '0', '2020-02-09', 'OP004', 'Rafika'),
	(18, '0', '2020-02-10', 'OP004', 'Purnama Indah');
...
-- Membuang data untuk tabel e_pos.transaksi: 2 rows
/*!40000 ALTER TABLE `transaksi` DISABLE KEYS */;
INSERT INTO `transaksi` (`transaksi_id`, `tanggal_transaksi`, `operator_id`, `nama_customer`) VALUES
	(29, '2020-02-10', 'OP004', 'Shasa'),
	(28, '2020-02-10', 'OP004', 'Linda');
...
CREATE TABLE IF NOT EXISTS `transaksi_aruskas` (
  ...
  `nama_karyawan` varchar(50) DEFAULT '0',
...
INSERT INTO `transaksi_aruskas` (`aruskas_id`, `tanggal_kas`, `operator_id`, `nama_karyawan`) VALUES
	(1, '2020-02-10', 0, 'Reva'),
	(2, '2020-02-10', 0, 'Budi');
...
-- Membuang data untuk tabel e_pos.transaksi_detail: 23 rows
...
INSERT INTO `transaksi_detail` (`t_detail_id`, `barang_id`, `qty`, `transaksi_id`, `harga`, `status`) VALUES
	...
	(68, 327, 100, 28, 2000, '1'),
	(62, 328, 100, 26, 500, '1'),
	(73, 326, 400, 29, 1200, '1');
